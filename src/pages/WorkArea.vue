<template>
    <h1>Here, we build and test out {{$filters.uppercase('components')}}</h1>
...
import { ref, onMounted } from 'vue'
    ...
    function dropdownFunction(event) {
        ...
        andicator(single, event.currentTarget);
    }
    ...
    function andicator(single, target) {
